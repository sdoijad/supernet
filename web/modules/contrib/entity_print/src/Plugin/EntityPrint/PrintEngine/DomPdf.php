...
class DomPdf extends PdfEngineBase implements ContainerFactoryPluginInterface {
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $form['enable_debug'] = [
      '#title' => $this->t('Enable debug output to watchdog'),
      '#type' => 'checkbox',
      '#default_value' => $this->configuration['enable_debug'],
      '#description' => $this->t("Check to enable DomPdf debug logging to watchdog."),
    ];
    $form['enable_remote'] = [
  ...
  public function send($filename, $force_download = TRUE) {
    ...
    // global it provides.
    if ($errors = $this->getError() && $this->configuration['enable_debug']) {
